 ...
 * (CWE-693 fail-open).
 */
export class DefenseEvasionCarrierPythonAttacker extends CoverageDifferentialPythonLane {
  constructor() {
    super("defense-evasion-carrier-python", CORPUS, "defense-evasion / security-control disable");
  }
}
